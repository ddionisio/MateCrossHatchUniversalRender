...
Shader "M8/Universal Render Pipeline/CrossHatch/Simple Lit"
{
    ...
    Properties
    {
        ...
        //Cross-Hatch
        _CrossHatchColor("Cross Hatch Color", Color) = (0.0, 0.0, 0.0, 1.0)
        _CrossHatchMap("Cross Hatch Map (RGBA)", 2D) = "white" {}
        _CrossHatchMap_TriPlanar_Scale("Cross Hatch Tri Planar Scale", Float) = 1.0

        [HideInInspector] _CrossHatchUVMode("__crossHatchUVMode", Float) = 0.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex CrossHatchLitPassVertexSimple
            #pragma fragment CrossHatchLitPassFragmentSimple
            #define BUMP_SCALE_NOT_SUPPORTED 1

            #include "CrossHatchSimpleLitInput.hlsl"
            #include "CrossHatchSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
